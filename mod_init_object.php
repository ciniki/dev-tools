...
function generate_delete() {
    ...
    $file = ""
        ...
        . "        return array('stat'=>'fail', 'err'=>array('pkg'=>'ciniki', 'code'=>'" . $cur_code++ . "', 'msg'=>'{$object_def['name']} does not exist.'));\n"
        . "    }\n"
...
function generate_update() {
	...
	$file .= "    //\n"
        ...
        . "    //\n"
        . "    ciniki_core_loadMethod(\$ciniki, 'ciniki', 'core', private', 'hookExec');\n"
        . "    ciniki_businesses_hookExec(\$ciniki, \$args['business_id'], 'ciniki', 'web', 'indexObject', array('object'=>'{$package}.{$module}.{$object}', 'object_id'=>\$args['{$object_id}']));\n"
        . "\n"
		. "    return array('stat'=>'ok');\n"
		. "}\n"
		. "?>\n"
